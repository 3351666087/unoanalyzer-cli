...
export const CURATED_ENDPOINTS: Endpoint[] = [
  ...
  { id: "course.join", method: "POST", path: "/api/cn/courses/join", category: "courses", params: [], source: "curated", description: "Join a course. Body: { code }." },
  ...
  { id: "chat.send", method: "POST", path: "/api/cn/student/:studentUid/course/:courseId/chat", category: "assistant", params: [p("studentUid"), p("courseId")], source: "curated", description: "Ask the course assistant. Body: { message }." },
  ...
  { id: "group.rename", method: "PATCH", path: "/api/cn/groups/:groupId/name", category: "groups", params: [p("groupId")], source: "curated", description: "Rename a group. Body: { name }." },
  ...
  { id: "group.invite", method: "POST", path: "/api/cn/groups/:groupId/invite", category: "groups", params: [p("groupId")], source: "curated", description: "Invite a member to the group." },
  ...
  { id: "group.taskAdd", method: "POST", path: "/api/cn/groups/:groupId/tasks", category: "groups", params: [p("groupId")], source: "curated", description: "Add a task. Body: { text, ... }." },
  ...
  { id: "weeklyLog.setGroup", method: "PUT", path: "/api/cn/courses/:courseId/groups/:groupId/weekly-logs/:week", category: "weekly-log", params: [p("courseId"), p("groupId"), p("week")], source: "curated", description: "Set the whole group's weekly log for a week." },
  { id: "weeklyLog.myEntry", method: "PUT", path: "/api/cn/courses/:courseId/groups/:groupId/weekly-logs/:week/my-entry", category: "weekly-log", params: [p("courseId"), p("groupId"), p("week")], source: "curated", description: "Submit/update MY entry for a week. Body: the entry object." },
  ...
  { id: "records.create", method: "POST", path: "/api/cn/records", category: "records", params: [], source: "curated", description: "Create a record. Body: { title, description?, date, course_id?, space_id?, context_type?, location?, link_url?, keep_private? }." },
  ...
  { id: "space.create", method: "POST", path: "/api/cn/student/:studentUid/spaces", category: "spaces", params: [p("studentUid")], source: "curated", description: "Create a personal space. Body: { name }." },
  ...
  // --- Misc helpers -----------------------------------------------------
  { id: "toEnglish", method: "POST", path: "/api/cn/to-english", category: "misc", params: [], source: "curated", description: "Translate text to English. Body: { text }." },
];
